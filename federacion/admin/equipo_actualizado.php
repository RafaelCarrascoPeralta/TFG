                ...
                if (isset($_FILES['imagen'])) {
                    ...
                    if ($errores == 0) {
                        ...
                        if (move_uploaded_file($directoriotemp, $nombreimagen)) {
                            // Copiar la imagen a /admin/imagen
                            $adminImagenDir = "/var/www/html/admin/imagen/" . $nombrearchivo;
                            if (!copy($nombreimagen, $adminImagenDir)) {
                                echo "Error al copiar la imagen al directorio de administración.";
                            }
                        } else {
                            echo "Error al mover la imagen al directorio de subida.";
                        }
                    }
                }
